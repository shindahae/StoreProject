						...
						$(v)
								.each(
										function(index, dom) {
											...
											temp += "<input id=\""
													+ dom.no
													+ "\" type=\"checkbox\" style=\"margin-top: 60%\">";
											temp += "</div>";
											...
											temp += "<input type=\"text\" name=\""+dom.no+"\" style=\"float:left; width:45%; height:35px; font-weight: bold; padding-left: 35px;\" value=\""+dom.cartamount+"\">";
...
<body onload="cartList()">
	...
	<div
		...
		<input id="deletebt" type="button" value="선택삭제"
		...
		<input id="" type="button" value="비우기"
		...
		<input id="backbt" type="button" value="쇼핑 계속하기"
		...
		<input id="orderbt" type="button" value="선택 주문하기"
			style="cursor: pointer; float: left; margin-left: 3%; border: 1px solid gray; width: 15%; background-color: black; color: white; font-weight: bold; padding-top: 15px; padding-bottom: 15px; font-size: 14px;">
	</div>
